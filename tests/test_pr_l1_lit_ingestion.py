...
def test_review_tips_keys_unchanged():
    ...
    or a new tips key. REVIEW_TIPS_KEYS has 7 keys as of PR-1 (2026-07-10
    trustworthy-curation-relevance-gate design): review_search_tips/
    review_snowball_tips were replaced by review_screen_tips/
    review_curate_tips (review-loop-nodekind-drift-fix), and PR-1 added
    review_relevance_verify_tips for the new cold final-corpus verifier
    node — both breaking key changes unrelated to PR-L1's own scope."""
