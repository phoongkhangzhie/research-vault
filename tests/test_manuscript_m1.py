...
def test_manuscript_in_verb_registry():
    ...
    # The when_to_use text describes the shipped (post-build-wave) capability,
    # not an earlier-stage stub.
    assert _VERB_REGISTRY["manuscript"]["module"] == "research_vault.manuscript.verbs"
