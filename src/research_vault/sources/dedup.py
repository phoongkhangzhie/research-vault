...
"""sources/dedup.py — cross-source identity collapse.
...
independently surfaced the paper — the raw signal the utility-ranker's
"coverage" dim and the derivative-of discounting both consume.
"""
