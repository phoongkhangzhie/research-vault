...
_DEFAULT_REVIEW_TIPS: dict[str, str] = {
    ...
    "review_curate_tips": (
        ...
        "Likewise CARRY the Rerank value VERBATIM from `_corpus_raw.md`'s "
        "own 8th (`Rerank`) column into this new 5th column — a strength "
        "signal for later corpus-bound curation, not a judgment call of "
        "yours. `_corpus_raw.md` rows show a bare `—` dash when no rerank "
