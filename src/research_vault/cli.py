...
_VERB_REGISTRY: dict[str, dict] = {
    ...
    "review": {
        ...
        "when_to_use": (
            ...
            "→ coverage-gate (auto-resolved)) with protocol-freeze, "
            "internal saturation loop (both forward cited-by + backward references), a "
            "relevance gate (mechanical off-domain pre-filter + a cold canary-verified "
