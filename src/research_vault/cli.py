...
_VERB_REGISTRY: dict[str, dict] = {
    ...
    "review": {
        ...
        "when_to_use": (
            ...
            "review-search → review-snowball → coverage-gate (auto-resolved)) with protocol-freeze, "
    ...
    "manuscript": {
        ...
        "when_to_use": (
            ...
            "-> approve-framework (auto-resolved)) — the organizing taxonomy is a HUMAN "
            ...
            "approve-manuscript (auto-resolved). Sections are built from injected data (numbers, "
