...
def _build_experiment_manifest(
    ...
    reads: uses absolute paths (the absolute-reads-pointer pattern from the review scaffold).
    ...
    def _abs(okf_type: str) -> str:
        """Absolute OKF type-dir pointer (mirrors review/__init__.py's absolute-reads-pointer pattern)."""
