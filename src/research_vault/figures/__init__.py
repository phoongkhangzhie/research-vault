...
The `style` module exports `apply_style(preset, skin)` — the seam that the designer
replaces with the real aesthetic (BeautifulFigures adaptation + frontend-design skin).
The plumbing calls `apply_style` before plotting; the designer owns what it does.
