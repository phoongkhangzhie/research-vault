...
def _git_init_vault(target: Path) -> None:
...
def cmd_init_in_dir(target_dir: str) -> int:
    ...
    print(f"  created: control/vault.md")
    ...
    print(f"  created: doctrine/ ({doctrine_files} files)")
    ...
    try:
        ...
        print(f"  created: {scaffold.MANIFEST_NAME} (framework v{fw_version})")
    except Exception as exc:
        print(
