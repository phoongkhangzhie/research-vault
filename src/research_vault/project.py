...
<!-- Add a key design/task link when it exists:
design-of-record: /path/to/tasks/key-task.md
-->
"""
...
def cmd_new(
    ...
    *,
    ...
    Sequence (register-first, then scaffold):
      ...
      6. devlog.cmd_init.
      7. pointers.md (lightweight read-fresh pointer skeleton — SR-LENS-RM).
    ...
    try:
        ...
        # ── STEP 7: pointers.md (read-fresh project-context pointer skeleton) ──
...
def build_parser(
    ...
    new_p = sub.add_parser(
        ...
        help=(
            ...
            "control bus + DEVLOG + library.json + crew."
        ),
    )
