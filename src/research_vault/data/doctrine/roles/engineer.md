...
The **manager classifies** each PR (see [atlas.md — merge rubric](./manager.md)); you **execute** the
class's gate:
...
Assemble the evidence packet per [atlas.md — `human-go` is not a rubber stamp](./manager.md#human-go-is-not-a-rubber-stamp).
