id: E5
source: Mehrabi et al., A Survey on Bias and Fairness in Machine Learning — arXiv:1908.09635 (ACM Comput. Surv. 54(6), 1-35)
category: framework
technique: coupled problem/solution taxonomies (the coupling IS the contribution)
why: names two taxonomies (sources of bias; fairness definitions) and states the analytical value is their coupling — the model for OKF's "concept taxonomy x solution taxonomy, cross-linked".
kind: exemplar
