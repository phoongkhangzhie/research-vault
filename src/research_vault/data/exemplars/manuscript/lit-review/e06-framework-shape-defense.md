id: E6
source: Mehrabi et al., Bias and Fairness Survey — arXiv:1908.09635
category: framework
technique: defending the taxonomy's shape against a naive alternative
why: rejects the naive grouping and argues the categorization must model the feedback loop — exemplary "why THIS spine, not the easy one" defense the human-selected framework needs.
kind: exemplar
